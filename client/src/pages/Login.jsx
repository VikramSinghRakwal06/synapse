    ...
    <div className="min-h-screen bg-void bg-grid-pattern flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-void-light/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-gaming text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-purple tracking-widest uppercase">Synapse</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input type="email" required className="w-full bg-void-lighter/50 border border-white/5 text-white p-3 rounded-lg focus:outline-none focus:border-neon-blue focus:shadow-neon-blue transition-all duration-300 placeholder-white/20"
          ...
          <div>
            ...
            <input type="password" required className="w-full bg-void-lighter/50 border border-white/5 text-white p-3 rounded-lg focus:outline-none focus:border-neon-purple focus:shadow-neon-purple transition-all duration-300 placeholder-white/20"
              placeholder="••••••••"
              value={formData.password} onChange={(e) => setFormData({...formData, password: e.target.value})}
            />
          </div>

          <button disabled={isLoading} className="w-full py-3 mt-4 bg-gradient-to-r from-neon-blue to-neon-purple rounded-lg font-bold font-gaming tracking-wide text-white hover:opacity-90 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed">
        ...
        <div className="mt-4 border-t border-white/10 pt-4">
             <button onClick={handleGuest} className="w-full py-2 border border-white/20 rounded-lg font-gaming text-xs text-starlight-dim hover:bg-white/5 hover:text-white transition-all">
                ENTER AS GUEST
            </button>
        </div>
